  ...
  return (
    <>     
      ...
      <div className="container my-5 py-2">
        ...
        <p>
          This site is owned by Tap Foodworks Limited. This Privacy Policy is
        ...
        <p>
          Pizza Man may collect personal information from you including your
          first and last name, address, telephone and mobile number(s), email
          address, credit card details and any other information, when you
        ...
        <p>
          Where ever Pizza Man collects personal information about you from
          someone else, Pizza Man or the franchisee will take reasonable steps
          to advise you.
        </p>
        <br />
        <h4>
        ...
        <p>
          Pizza Man may use the personal information that you submit to
          restaurant and process that information in order to provide goods and
        ...
        <p>
          And to now and again send you offers or information on products or
        ...
        <p>
          ...
          future. When concluding your order via the Pizza Man internet ordering
          system, you will be asked if you would like to become a WOW Club
          member. To not become a member untick the box.
        </p>
        <br />
        <h4>
        ...
        <p>Pizza Man does not store any of your credit card details.</p>
        <br />
        <h4>
        ...
        <p>
          ...
          themselves and with companies that are related to Pizza Man including
          our international branches.Personal information that you submit to
          Pizza Man may be disclosed to a third party: Such as our suppliers, as
          mailing houses, who are employed to provide some of our services such;
        ...
        <ul>
          ...
          <li>
            {" "}
            If Pizza Man are required or authorized by law to disclose the
            information.{" "}
          </li>
          <li>
            {" "}
          ...
          <li>
            {" "}
            If Pizza Man feel you might like to know about a third party's goods
            and services we may supply that personal information to that third
            party. (We know that many of our guests enjoy receiving these
            excellent offers).{" "}
          </li>
          <li>
            {" "}
            Or if you place an order via our internet order system, your details
            will be passed on to Verisign, who receive your credit card details
            for internet order payment. Verisign is a secure internet payment
            gateway that secures your credit card number during transmission.
            See: www.verisign.com for further details.{" "}
          </li>
        </ul>
        <br />
        <h4>
          <strong>Access, Accuracy and Security</strong>
          <hr />
        </h4>
        <p>
          Pizza Man will take reasonable steps to ensure that the personal
          ...
          contacting us.Pizza Man will take reasonable steps to protect personal
          information from misuse, loss and unauthorized access, modification or
          disclosure.
        </p>
        <br />
        <h4>
        ...
        <p>
          Pizza Man will not collect, use or disclose sensitive information
        ...
        <p>
          Each time you visit the Pizza Man's site our server collects some
          ...
          visit; and your server's IP address. Pizza Man may collect this
          ...
          duration of visits, most popular session times. Pizza Man may use this
          information to evaluate and improve the Pizza Man's websites.
        </p>
        <br />
        <h4>
        ...
        <p>
          ...
          your machine when you visit a Pizza Man's site. A Cookie helps us to
          recognize you when you re-visit our sites and to co-ordinate your
        ...
        <p>
          ...
          Policy was last updated on August 22, 2020.
        </p>
      </div>
    </>
  );
