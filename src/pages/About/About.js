  ...
  return (
    <>
      ...
      <div className="container my-5 py-2">
        <h4>
          <strong>Pizza Man: Delivering Happiness</strong>
          <hr />
        </h4>
        ...
        <p>
          With Pizza Man it is always “Rishton ka time”. Whether it's a treat
          for your promotion, a kid topping his class or winning the heart of
          your wife who is too tired to cook after a long day at work! A cheesy
          slice of the best pizza is all one needs to put things into
          perspective and start any celebration. Plus, you do not even need to
          rush to the restaurant to have one now. A call, a few clicks on our
          website or a few touches on the mobile screen is all you have to do to
          have that tempting, light-on-the-pocket pizza at your doorstep.
        </p>
        <p>
        ...
        <br />
        <h4>
          <strong>What We Need - More Choice. More Fun.</strong>
          <hr />
        </h4>
        <p>
          ...
          pizza. Because just like a pizza, Pizza Man understands you.
        </p>
        <br />
        <h4>
          <strong>The Promise Of 30-Minute Delivery</strong>
          <hr />
        </h4>
        <p>
          The icing on the cake or more aptly the extra cheese on your already
          fabulous pizza is that Pizza Man takes only half an hour for its pizza
          delivery service. Don’t believe us? Time it if you please. With 1250+
          stores present all over India, you can have a Pizza Man pizza even
